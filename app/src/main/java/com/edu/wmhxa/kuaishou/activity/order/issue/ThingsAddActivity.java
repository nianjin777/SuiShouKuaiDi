package com.edu.wmhxa.kuaishou.activity.order.issue;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.add_bt_setplace:
                ...
                intent.setClassName("com.edu.wmhxa.kuaishou", "com.edu.wmhxa.kuaishou.activity.order.issue.ChoosePositionActivity");
