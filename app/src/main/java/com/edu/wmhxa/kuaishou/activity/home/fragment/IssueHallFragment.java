package com.edu.wmhxa.kuaishou.activity.home.fragment;
...
import com.edu.wmhxa.kuaishou.activity.home.HomeActivity;
import com.edu.wmhxa.kuaishou.model.BeanThing;
import com.edu.wmhxa.kuaishou.util.ListViewUtil;
import com.edu.wmhxa.kuaishou.util.adapter.ThingListAdapter;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.issue_rl_address:
                //选择地址
                intent.setClassName("com.edu.wmhxa.kuaishou", "com.edu.wmhxa.kuaishou.activity.setting.address.AddressChooseAcrtivity");
                startActivity(intent);
                break;
            case R.id.issue_bt_addthing:
                //添加物品
                intent.setClassName("com.edu.wmhxa.kuaishou", "com.edu.wmhxa.kuaishou.activity.order.issue.ThingsAddActivity");
